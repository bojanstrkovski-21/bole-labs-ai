---
name: python-ai
description: Build and troubleshoot Python AI applications with uv, local LLMs, OpenAI APIs, OpenRouter, agent frameworks, retrieval, tool calling, evaluation, and AI developer tooling. Use when the agent is asked to implement Python AI features, manage AI dependencies, design prompts or agents, debug model calls, or prepare AI app validation.
---
