---
name: rust-cli
description: Design, implement, test, document, and release Rust command line applications using Cargo, clap, integration tests, error handling, and CLI UX conventions. Use when the agent is asked to build or review a Rust CLI, add commands or flags, improve tests, package releases, or debug Cargo workflows.
---
